...
public struct Regift {
    ...
    public func createGif(caption : String?, font : UIFont?) -> URL? {
        ...
        do {
            ...
            if let caption = caption, let font = font {
                ...
                return try createGIFForTimePoints(timePoints: timePoints, fileProperties: fileProperties as [String : AnyObject], frameProperties: frameProperties as [String : AnyObject], frameCount: frameCount, size: size)
            }
    ...
    /**
     ...
     - returns: The path to the created GIF, or `nil` if there was an error creating it.
     */
    public func createGIFForTimePoints(timePoints: [TimePoint], fileProperties: [String: AnyObject], frameProperties: [String: AnyObject], frameCount: Int, size: CGSize? = nil) throws -> URL {
    ...
    /// :param: caption
    ///
    public func createGIFForTimePointsAndCaption(timePoints: [TimePoint], fileProperties: [String: AnyObject], frameProperties: [String: AnyObject], frameCount: Int, caption: NSString, font: UIFont) throws -> URL {
        let temporaryFile = (NSTemporaryDirectory() as NSString).appendingPathComponent(Constants.FileName)
